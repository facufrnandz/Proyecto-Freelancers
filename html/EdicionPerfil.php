...
<html>
    ...
    <head>
        ...
        <title>Perfil de Freelancer - Registro de datos</title>

        <link href="style/EditarPerfil.css" rel="stylesheet">
    </head>
    ...
    <body>
        ...
        <section class="container rounded" id="datos"> 
            ...
            <form action="" method="POST">
                ...
                min="1940-01-01" max="2002-01-01" required >

                <input class="btn btn-block text-white" type="submit" value="Finalizar">
