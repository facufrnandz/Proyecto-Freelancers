    ...
    <body class="text-left">
        ...
        <div class="container-fluid" id="barra-superior">
            ...
            <div class="text-center" id="barra-de-navegacion">
                <a href="entrevistas-freelancer" class="texto-de-navegacion">Entrevistas</a> 
        ...
        <section class="container rounded text-center" id="datos"> 
            ...
            <section class="text-center">
                <a href="edicion-freelancer">Editar datos</a>
            </section>
        ...
        <section class="container rounded text-center" id="datos"> 
            ...
            <a href="edicion-curriculum">Editar Curriculum</a>
